...
# in /gpfs0/alal/users/amitgefe/preprocess_chm13v2.0
#origin from "/gpfs0/alal/users/amitgefe/preprocess_chm13v2.0/test_outputs.py"
import os
import sys
import numpy as np
import pandas as pd
...
print("\n\n" , os.getcwd())
model_path = sys.argv[1]#"/gpfs0/alal/users/amitgefe/IP_classifier/tests/SPW_HPT_model.sav"
...
id2seq = FASTA_reader(csv_path +  "collapse_putative_updated.fasta") #_updated
...
df['seq'] = df.seqID.apply(lambda x: id2seq[x] if x in id2seq else None) # collapse_putative header- seq*|PU
...
# python3.8 make_results_updated.py "/gpfs0/alal/users/amitgefe/IP_classifier/XGB_model.sav" ./   #final model
